...
/**
 * created by samwsm at 2019-08-25 13:32
 * update by samwsm at 2019-08-25 13:32
 * updateDetail :
 */
public class ZoomImageView extends android.support.v7.widget.AppCompatImageView
    ...
    private void initParametersForRegion(MotionEvent event) {
        ...
        float dstX = dst[0];
        float dstY = dst[1];
        onItemClickListener.onItemClick(dstX, dstY);
    }

    public interface OnItemClickListener {
        void onItemClick(float dstX, float dstY);
    }
