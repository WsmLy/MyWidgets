...
public class ZzImageBox extends RecyclerView {
    ...
    private static class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = mInflater.inflate(R.layout.item_zz_image_box, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            if (holder.getAdapterPosition() == getItemCount() - 1 && !lastOne) {
                ...
                holder.ivPic.setImageResource(addPic == -1 ? R.mipmap.guide_icon03_fabu: addPic);
                ...
                holder.ivDelete.setImageResource(deletePic == -1 ? R.mipmap.ic_launcher : deletePic);
