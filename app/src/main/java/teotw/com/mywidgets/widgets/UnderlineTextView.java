...
public class UnderlineTextView extends TextView {
    ...
    public UnderlineTextView(Context context, AttributeSet attrs) {
        ...
        underlineWidth = (int)typedArray.getDimension(R.styleable.UnderlineTextView_underline_width,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics()));
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (isShowUnderline) {
            ...
            canvas.drawRect((getWidth() - underlineWidth) / 2, getHeight() - underlineHeight, (getWidth() - underlineWidth) / 2 + underlineWidth, getHeight(), paint);
        }
        super.onDraw(canvas);
    }
}