...
import teotw.com.mywidgets.stickUtils.MTask;
import teotw.com.mywidgets.stickUtils.ProperyAnimationUtils;

/**
 * Created by wsm on 19/07/31.
 */
public class StickyLayout extends LinearLayout {
    ...
    private View             ivPelletFloatingLayer;
    ...
    public void initData() {
        ...
        if (headerId != 0 && contentId != 0) {
            ...
            ivPelletFloatingLayer = findViewById(R.id.ll_head_content);
        ...
        if (mHeader != null && mHeader.getLayoutParams() != null) {
            ...
            if (heightChangeListener != null) {
                if (height == mOriginalHeaderHeight) {
                    ...
                    heightChangeListener.notifyChange(height / (mOriginalHeaderHeight * 1f));
